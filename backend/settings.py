...
SECRET_KEY = 'django-insecure-4$oq$w=mylynmfu=&$0&-h-d7ewthe5+l*vm5%x%9$1akcrmxz'
...
INSTALLED_APPS = [  # Provides which apps are available as a resource to it
    # Find app and load this application
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # Comes from django.contrib.auth
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Comes from django.contrib.auth
